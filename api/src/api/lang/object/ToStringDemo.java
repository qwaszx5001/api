...
public class ToStringDemo {
	public static void main(String[] args) {
		...
		/*
		 * java.lang.Object 의 toString 은 해시코드(객체 주소값)을 리턴하므로, 
		 * toString() 을 오버라이딩해서 원하는 결과를 얻도록 한다.
		 * 
		 * */

}
// 현 java 파일에 두개 이상의 클래스가 있어도 되나..
...
class Card{
	...
	public Card(String kind, int number) {
		...
		// CTRL + Space 에서 toString 을 만들면 하드코딩이 늘어난다.
		// ALT + SHIFT + S 를 한후 generate toString을 선택하여 생성한다. 

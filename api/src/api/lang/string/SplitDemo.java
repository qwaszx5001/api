...
public class SplitDemo {
	public static void main(String[] args) {
		...
		System.out.println("공백1"+Arrays.toString(fruits2));
		
		String[] fruits3 = fruit.split(",",2);
		System.out.println("공백2"+Arrays.toString(fruits2));
		
		String[] fruits4 = fruit.split(",",3);
		System.out.println("공백3"+Arrays.toString(fruits2));
		
		String[] fruits5 = fruit.split(",",4);
		System.out.println("공백4"+Arrays.toString(fruits2));

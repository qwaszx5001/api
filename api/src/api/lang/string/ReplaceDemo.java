...
public class ReplaceDemo {
	public static void main(String[] args) {
		...
		/*
		 * 위 문법은 자바버전 5(JDK1.5) 까지의 문법입니다.
		 * 버전 5이후 replace()기능이 확대되어 replaceAll()처럼 복수의 글자에도 반응하게 되었습니다.
		 * 그렇다면 차이점이 없냐? 아닙니다. 정규직에 대한 기능이 있는지 없는지
		 * 여부에 따른 차이점이 있습니다.
		 * */
		 ...
		 * 그러니까 느낌표가 두개 있는데 앞에 맨 뒷 녀석만 남기겠다는 의미이고 이 기능은 replaceAll()에게만 있습니다.
		 * 따라서 replace() 보다는 정규식까지 처리기능한 replaceAll()를 쓰라고 권장합니다.
		 *
		 * */
	}	
}
